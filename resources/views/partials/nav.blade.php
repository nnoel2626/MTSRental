       					...
       					<div class="col-sm-8">
       						<div class="shop-menu pull-right">
       							...
       							@if(Auth::check())
       								...
       								<li><a href="{!! URL::to('rental/cart') !!}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
       					...
       					<div class="col-sm-9">
       						...
       						<div class="mainmenu pull-left">
       							<ul class="nav navbar-nav collapse navbar-collapse">
       								...
       								<li>{!! HTML::link('rental', 'Shop')!!}</li>
       								<li><a href="404.html">404</a></li>
       								<li>{!! HTML::link('rental/contact', 'Contact')!!}</li>
       							</ul>
       						</div>
       					</div>
       					<div class="col-sm-3">
       						<div class="search_box pull-right">
       							  {!! Form::open(array('url' => 'rental/search', 'method' => 'GET')) !!}
