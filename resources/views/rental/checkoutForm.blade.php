            ...
            <div class="row">
              <div class="col-sm-5 clearfix">
                ...
                <div class="bill-to">
                  <h2>Bill To</h2>
                  <div class="form-one">
                   {!! Form::open(array('route' => 'rental.checkout', 'method'=>'post')) !!}                 
    				...
    				<p>${!! $equipment->price !!}</p>
    							...
    							<td class="cart_quantity">
    								<div class="cart_quantity_button">
    									...
    									<input class="cart_quantity_input" type="text" name="quantity" value="{!! $equipment->quantity !!}" autocomplete="off" size="2">
