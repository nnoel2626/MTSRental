...
class Equipment extends \Eloquent {
	...
	protected $fillable = array('name', 'brand', 'model',
	 'serial_number', 'price', 'availability', 'image_path');
	...
	public static $rules = array (
	    ...
	    public function updateCategories($new = array()) {
	        // Go through new categories to see what ones need to be added
	    		foreach($new as $category) 
	    		{
	    				...
	    				{	
	    			   		$this->categories()->save(App\Category::find($category));
	    				}
	    		}
	    ...
	    */
	    ...
	    $equipment = App\Equipment::where('created_at','>',$past_24_hours)->get();
	    return $equipment;
	    }
	    ...
	    public static function scoperecent() {
	        ...
	        $equipment = App\Equipment::groupBy('day')->get([
